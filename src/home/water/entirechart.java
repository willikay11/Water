...
public class entirechart extends javax.swing.JFrame {
...
public void get(){
   ...
   int b = Integer.valueOf(g);
     for (int i = b; i >= 1; i--) {
         ...
         txtno.setText(A);
String sql = "SELECT `sum`,`month` from chart WHERE `monthN`= '"+A+"'";
try{
...
public void use(){
String sql = "Select `sum`,`month`from chart";
        try{
            pst = conn.prepareStatement(sql);
            rs = pst.executeQuery();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(entirechart.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new entirechart().setVisible(true);
            }
        });
    }
