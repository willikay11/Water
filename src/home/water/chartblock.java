...
public class chartblock extends javax.swing.JFrame {
...
public void get(){
   ...
   Z=g;
     for (int i = b; i >= 1; i--) {
         ...
         txtno.setText(A);
String sql = "SELECT `sum`,`month` from chartblock WHERE `name` =  '"+cboblock.getSelectedItem()+"' and `monthN`= '"+A+"'";
try{
...
public void use(){
String sql = "Select `sum`,`name`,`month`,`year` from chartblock where `name` = '"+cboblock.getSelectedItem()+"'";
        try{
            pst = conn.prepareStatement(sql);
            rs = pst.executeQuery();
            charts.setModel(DbUtils.resultSetToTableModel(rs));
            cbobasis.setEnabled(true);
        }catch(Exception e){
            JOptionPane.showMessageDialog(null, e);
        }
}
...
JOptionPane.showMessageDialog(null, e);
    ...
    private void initComponents() {
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addComponent(cboblock, javax.swing.GroupLayout.PREFERRED_SIZE, 144, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(75, 75, 75)
                .addComponent(jLabel1)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(cbobasis, javax.swing.GroupLayout.PREFERRED_SIZE, 121, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void cmdChartActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdChartActionPerformed
        ...
        JOptionPane.showMessageDialog(null, "No info to be displayed");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(chartblock.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new chartblock().setVisible(true);
            }
        });
    }
